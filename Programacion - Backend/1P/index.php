...
$tituloVentana = "ALUMNOS - con archivos y AJAX -";
?>
<!doctype html>
<html>
<head>
	...
	<link href="./img/Koala.png" rel="icon" type="image/png" />
						...
						<td width="50%">
							<div id="divFrm" style="height:350px;overflow:auto;margin-top:20px">
								<form id="frm" enctype="multipart/form-data" >
									...
									<input type="button" class="MiBotonUTN" onclick="Main.AgregarAlumno()" value="Guardar"  />
