...
class AccesoDatos
{
    ...
    {
        try {
            $this->_objetoPDO = new PDO('mysql:host=localhost;dbname=heroku_586770c123f6dd2;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
