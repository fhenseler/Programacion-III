...
class User
{
	...
	public static function getUserDataByNombrePasswordSexoPerfil($nombre, $pass, $sexo, $perfil)
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
	...
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
		$consulta = $objetoAccesoDato->RetornarConsulta("select nombre,pass,sexo from usuarios where nombre = :nombre and pass = :pass and sexo = :sexo");
		$consulta->bindValue(':pass', $pass, PDO::PARAM_STR);
		$consulta->bindValue(':nombre', $nombre, PDO::PARAM_STR);
		$consulta->bindValue(':sexo', $sexo, PDO::PARAM_STR);
		$consulta->execute();
